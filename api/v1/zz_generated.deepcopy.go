...
func (in *ControlledJobSpec) DeepCopyInto(out *ControlledJobSpec) {
	*out = *in
	...
	if in.Events != nil {
		...
		*out = make([]ScheduleEventSpec, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScheduleEventSpec) DeepCopyInto(out *ScheduleEventSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScheduleEventSpec.
func (in *ScheduleEventSpec) DeepCopy() *ScheduleEventSpec {
	if in == nil {
		return nil
	}
	out := new(ScheduleEventSpec)
	in.DeepCopyInto(out)
	return out
}
